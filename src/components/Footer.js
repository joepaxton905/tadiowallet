    ...
    <footer className="relative bg-dark-900/50 border-t border-white/5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-dark-400 text-sm leading-relaxed mb-6 max-w-xs">
              {config.tagline}. Your trusted partner for buying, selling, and managing cryptocurrency.
            </p>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-dark-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300"
                aria-label="Twitter"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {config.footerLinks.product.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {config.footerLinks.company.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-dark-400 hover:text-white transition-colors duration-200 text-sm"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {config.footerLinks.resources.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-dark-400 hover:text-white transition-colors duration-200 text-sm"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {config.footerLinks.legal.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-dark-400 hover:text-white transition-colors duration-200 text-sm"
      ...
      <div className="border-t border-white/5 bg-dark-950/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-dark-500">
