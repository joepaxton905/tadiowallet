  ...
  return (
    <>
      ...
      <aside
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(10, 15, 28, 0.98) 0%, rgba(5, 10, 20, 0.99) 100%)',
          ...
          <div className="p-4 border-t border-white/5">
            <div className="glass-card p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white">Quick Buy</p>
                  <p className="text-xs text-dark-400">Buy crypto instantly</p>
                </div>
              </div>
              <Link
                href="/dashboard/trade"
                className="block w-full py-2.5 text-center text-sm font-medium text-dark-950 bg-gradient-to-r from-primary-400 to-accent-500 rounded-lg hover:opacity-90 transition-opacity"
              >
                Buy Now
              </Link>
            </div>
