    ...
    <div className="space-y-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded border-white/20 bg-dark-900 text-primary-500 focus:ring-primary-500/20 focus:ring-offset-0"
            />
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-4 rounded-xl font-semibold text-dark-950 bg-gradient-to-r from-primary-400 to-accent-500 hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
        >
          {isLoading ? (
            <>
